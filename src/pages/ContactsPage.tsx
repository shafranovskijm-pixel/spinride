...
export default function ContactsPage() {
  ...
  return (
    <ShopLayout>
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">{page?.title || "Контакты"}</h1>
          <p className="text-muted-foreground">
            {page?.subtitle || "Свяжитесь с нами любым удобным способом"}
          </p>
        </div>
            ...
            <CardContent className="space-y-2">
              {content?.social?.telegram && (
                <Button variant="outline" className="w-full justify-start" asChild>
                  <a href={content.social.telegram} target="_blank" rel="noopener noreferrer">
              ...
              {content?.social?.whatsapp && (
                <Button variant="outline" className="w-full justify-start" asChild>
                  <a href={content.social.whatsapp} target="_blank" rel="noopener noreferrer">
                    <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
              ...
              {!content?.social?.telegram && !content?.social?.whatsapp && (
                <p className="text-sm text-muted-foreground">Мессенджеры не настроены</p>
              )}
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <p className="font-semibold mb-2">
                {content?.work_hours || "Пн-Пт: 10:00-19:00, Сб: 11:00-17:00, Вс: выходной"}
              </p>
